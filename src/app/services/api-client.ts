...
export interface IServiceProxy {
     ...
     * @return OK
     */
    createAdminUser(body?: UserRegistrationInputDto | undefined): Observable<User>;
    /**
     * @param body (optional)
     * @return OK
     */
...
export class ServiceProxy implements IServiceProxy {
     ...
     * @return OK
     */
    createAdminUser(body?: UserRegistrationInputDto | undefined, httpContext?: HttpContext): Observable<User> {
        let url_ = this.baseUrl + "/api/Users/CreateAdminUser";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCreateAdminUser(response: HttpResponseBase): Observable<User> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
